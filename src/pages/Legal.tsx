  ...
  return (
    <section className="pt-36 pb-20"><div className="container-x max-w-3xl"><Reveal><div className="glass p-8 prose-sm">
      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed">
        <p><b>CLEAN – Let it shine GmbH</b><br />Musterstraße 12<br />10115 Berlin</p>
        <p>Vertreten durch: Max Mustermann (Geschäftsführer)<br />Telefon: 0800 123 45 67<br />E-Mail: hallo@clean-shine.de</p>
        <p>Registergericht: Amtsgericht Berlin-Charlottenburg<br />Registernummer: HRB 000000<br />USt-IdNr.: DE000000000</p>
        <p>Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV: Max Mustermann, Anschrift wie oben.</p>
        <p className="text-muted">Hinweis: Dies ist eine Demo-Website. Alle Angaben sind Platzhalter.</p>
      </div>
  ...
  return (
    <section className="pt-36 pb-20"><div className="container-x max-w-3xl"><Reveal><div className="glass p-8">
      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted">
        <p><b className="text-text">1. Verantwortlicher</b><br />CLEAN – Let it shine GmbH, Musterstraße 12, 10115 Berlin, hallo@clean-shine.de</p>
