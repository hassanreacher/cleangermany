...
const mk = (over: Partial<Profile>): Profile => ({
  ...
  bathrooms: 1, floor: '2', elevator: true, pets: false, cleaningType: 'unterhalt', frequency: 'einmalig', extras: [], notes: '', ...over,
})
...
export const demoAppointments: Appointment[] = [
  ...
  { id: 'a3', code: 'CL-24831', createdAt: addDays(t, -7), date: addDays(t, -3), time: '14:00', durationH: 4, status: 'erledigt', price: 219, estimate: [200, 250], team: 'Team Süd', source: 'telefon',
    customer: mk({ name: 'Praxis Dr. Hoffmann', email: 'info@praxis-hoffmann.de', phone: '+49 89 5551234', street: 'Leopoldstraße 88', zip: '80802', city: 'München', propertyType: 'praxis', sizeSqm: 140, rooms: 6, bathrooms: 2, cleaningType: 'buero', frequency: 'woechentlich' }) },
  ...
  { id: 'a5', code: 'CL-24842', createdAt: addDays(t, -3), date: addDays(t, 2), time: '12:00', durationH: 2, status: 'bestaetigt', price: 79, estimate: [70, 90], team: 'Team Nord', source: 'ki',
    customer: mk({ name: 'Sophie Becker', email: 'sophie.becker@example.de', phone: '+49 69 7788990', street: 'Bornheimer Landstraße 5', zip: '60316', city: 'Frankfurt am Main', sizeSqm: 45, rooms: 2, frequency: 'zweiwoechentlich' }) },
  ...
  { id: 'a8', code: 'CL-24851', createdAt: t, date: addDays(t, 5), time: '08:00', durationH: 6, status: 'anfrage', price: null, estimate: [280, 350], source: 'web',
    customer: mk({ name: 'Bürogemeinschaft Nordlicht GmbH', email: 'office@nordlicht.example', phone: '+49 421 223344', street: 'Am Wall 120', zip: '28195', city: 'Bremen', propertyType: 'buero', sizeSqm: 240, rooms: 10, bathrooms: 3, cleaningType: 'buero', frequency: 'woechentlich', notes: 'Zugang ab 07:30 über Hinterhof.' }) },
