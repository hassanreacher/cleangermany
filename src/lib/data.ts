...
export const demoAppointments: Appointment[] = [
  ...
  { id: 'a3', code: 'CL-24831', createdAt: addDays(t, -7), date: addDays(t, -3), time: '14:00', durationH: 4, status: 'erledigt', price: 219, estimate: [200, 250], team: 'Team Süd', source: 'telefon',
    customer: mk({ name: 'Praxis Dr. Hoffmann', email: 'info@praxis-hoffmann.de', phone: '+49 30 5551234', street: 'Schloßstraße 88', zip: '12163', city: 'Berlin', propertyType: 'praxis', sizeSqm: 140, rooms: 6, bathrooms: 2, floorTypes: ['pvc', 'fliesen'], cleaningType: 'buero', frequency: 'woechentlich', timesPerPeriod: 3, timeWindow: 'abend' }) },
  { id: 'a4', code: 'CL-24838', createdAt: addDays(t, -4), date: addDays(t, 1), time: '08:00', durationH: 3, status: 'bestaetigt', price: 149, estimate: [130, 160], team: 'Team Süd', source: 'web',
    customer: mk({ name: 'Familie Müller', email: 'familie.mueller@example.de', phone: '+49 30 334455', street: 'Bahnhofstraße 21', zip: '12305', city: 'Berlin', propertyType: 'haus', sizeSqm: 130, rooms: 5, bathrooms: 2, pets: true, extras: ['fenster'] }) },
  ...
  { id: 'a6', code: 'CL-24845', createdAt: addDays(t, -2), date: addDays(t, 3), time: '10:00', durationH: 5, status: 'angebot', price: 289, estimate: [260, 320], source: 'web',
    customer: mk({ name: 'Jonas Fischer', email: 'jonas.fischer@example.de', phone: '+49 30 445566', street: 'Kurfürstendamm 30', zip: '10719', city: 'Berlin', sizeSqm: 110, rooms: 4, cleaningType: 'umzug', extras: ['backofen', 'kuehlschrank', 'fenster'] }) },
  ...
  { id: 'a9', code: 'CL-24853', createdAt: t, date: addDays(t, 7), time: '10:00', durationH: 2, status: 'bestaetigt', price: 95, estimate: [85, 105], team: 'Team Süd', source: 'web',
    customer: mk({ name: 'Elias Schulz', email: 'elias.schulz@example.de', phone: '+49 30 556677', street: 'Karl-Marx-Straße 14', zip: '12043', city: 'Berlin', sizeSqm: 64, rooms: 2, cleaningType: 'fenster' }) },
